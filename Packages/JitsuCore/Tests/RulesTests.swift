...
func rules_element_advantages() {
    let fire = Card(id: "f", element: .fire, level: 1, colour: .red)
    let water = Card(id: "w", element: .water, level: 1, colour: .red)
    let snow = Card(id: "s", element: .snow, level: 1, colour: .red)
...
func rules_same_element_power_tie_and_compare() {
    let f1 = Card(id: "f1", element: .fire, level: 1, colour: .red)
    let f1b = Card(id: "f1b", element: .fire, level: 1, colour: .red)
    let f3 = Card(id: "f3", element: .fire, level: 3, colour: .red)
